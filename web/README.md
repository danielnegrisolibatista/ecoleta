...
- Instalar o react-dropzone `npm install react-dropzone`
- Crie a pasta src/components
- Crie os arquivos src/components/Dropzone/index.tsx e src/components/Dropzone/style.css
...
```css
/* components/Dropzone/styles.tsx */
